...
public abstract class CredentialHandler extends JaxrsHandler {
   ...
   public CredentialHandler(final JSONObject config, final HandlerManagerIF handlerMgr) {
      super(config, handlerMgr);
      String METHOD = "CredentialHandler(config, handlerMgr)";
   ...
   /**
    * Remove duplicate data from the results. If there is more than one result in
    * the JSON array, delete all the items in the array, something went wrong. ...
